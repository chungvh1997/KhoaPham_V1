                            ...
                            <div class="item-inner">
                              ...
                              <div class="product-thumbnail">
                                ...
                                <div class="pr-img-area">
                                  <a title="Ipsums Dolors Untra"  href="<?=$product->id.'-'.$product->url?>.html">
                                    <figure>
                                      <img class="first-img" src="public/source/images/products/<?=$product->image; ?>" alt="html template">
                                      <img class="hover-img" src="public/source/images/products/<?=$product->image; ?>" alt="html template">
                                    </figure>
                                  </a>
                  ...
                  <div class="top-sellers-pro">
                    <div class="slider-items-products">
                      <div id="top-sellers-slider" class="product-flexslider hidden-buttons">
                        <div class="slider-items slider-width-col4 ">
                        <?php foreach($data['bestSeller'] as $productSeller):?>
                          <div class="product-item">
